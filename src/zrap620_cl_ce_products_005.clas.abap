CLASS zrap620_cl_ce_products_005 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_product_range TYPE RANGE OF zrap620_005sepmra_i_product_e-Product.
    TYPES t_business_data TYPE TABLE OF zrap620_005sepmra_i_product_e.
    ...
    METHODS get_products
      IMPORTING
        ...
        cl_http_destination_provide TYPE any OPTIONAL
      EXPORTING
...
CLASS ZRAP620_CL_CE_PRODUCTS_005 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA business_data TYPE TABLE OF zrap620_005sepmra_i_product_e.
  ...
  METHOD get_products.
    ...
    odata_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
      EXPORTING
        iv_service_definition_name = 'ZRAP620_SC_PRODUCTS_005'
